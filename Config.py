...
def cfg():
    # Base configuration
    model_config = {"musdb_path" : "Notebooks\Dataset", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    "estimates_path" : "Wave-u-net-output", # SET THIS PATH TO WHERE YOU WANT SOURCE ESTIMATES PRODUCED BY THE TRAINED MODEL TO BE SAVED. Folder itself must exist!
    ...
    elif model_config["task"] == "vocals":
        model_config["source_names"] = ["leadvocal", "soprano", "tenor", "alto", "bass", "vocal_percussion"]
    else:
